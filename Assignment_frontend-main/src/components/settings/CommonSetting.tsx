...
import { UseFormRegister, FieldErrors, set } from "react-hook-form";
...
interface CommonSettingProps {
  errors: FieldErrors<CommonSettingForm>;
  register: UseFormRegister<CommonSettingForm>;
  isSave: boolean;
  isSubmitting: boolean;
}

const CommonSetting = ({ errors, register, isSave, isSubmitting }: CommonSettingProps) => {
