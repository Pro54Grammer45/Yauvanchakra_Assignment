...
interface OfferProps {
  ...
  coupons: Option[];
  register: any;
  setOffersPageHeader: (value: boolean) => void;
  offersPageHeader: boolean;
  setOffersHeaderBg: (value: string) => void;
  offersHeaderBg: string;
  couponList1: Option[];
  setCouponList1: (value: Option[]) => void;
          ...
          <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
            ...
            <div className="sm:col-span-4">
              <SwitchToggle
                ...
                name={offersPageHeader.toString()}
              />
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
              ...
              <div className="sm:col-span-4">
                <MultiSelect
                  ...
                  value={couponList1}
                  className={mode}
                  onChange={(v: Option[]) => setCouponList1(v)}
