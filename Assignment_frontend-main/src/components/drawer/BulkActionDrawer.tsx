...
const BulkActionDrawer: React.FC<BulkActionDrawerProps> = ({
  ids,
  title,
  lang,
  data,
  ...
  //  type useBulkActionSubmit return value
  const {
    tag,
    setTag,
    published,
                    ...
                    <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                      ...
                      <div className="col-span-8 sm:col-span-4">
                        <ReactTagInput
                          ...
                          tags={tag}
                          onChange={(newTags: string[]) => setTag(newTags)}
                        />
                      </div>
                    </div>
                  </>
