  ...
  const Orders: React.FC = () => {
    ...
    const handleDownloadOrders = async () => {
      try {
        ...
        const exportData = res?.orders?.map((order: any) => {
          return {
            _id: order._id,
                ...
                <div className="grid gap-4 lg:gap-4 xl:gap-6 md:gap-2 md:grid-cols-5 py-2">
                  ...
                  <div>
                    <Select
                      ...
                      className="w-full"
                      value={statusValue}
                      onChange={(e: ChangeEvent<HTMLSelectElement>) => setStatusValue(e.target.value)}
                  ...
                  <div>
                    <Select
                      ...
                      className="w-full"
                      value={timeValue}
                      onChange={(e: ChangeEvent<HTMLSelectElement>) => setTimeValue(e.target.value)}
                      placeholder={t("Orderlimits")}
                      css={undefined}
                      onPointerEnterCapture={undefined}
                      onPointerLeaveCapture={undefined}
                    >
                  ...
                  <div>
                    <Select
                      ...
                      className="w-full"
                      value={methodValue}
                      onChange={(e: ChangeEvent<HTMLSelectElement>) => setMethodValue(e.target.value)}
          ...
          <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 rounded-t-lg rounded-0 mb-4">
            <CardBody>
              <div className="flex gap-1">
                {data?.methodTotals?.map((el: any, i: number) => (
